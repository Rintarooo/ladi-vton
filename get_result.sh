...
python3 src/inference.py --dataset vitonhd --vitonhd_dataroot zalando-hd-resized --output_dir result --test_order paired --category upper_body  --batch_size 4 --mixed_precision no --num_workers 8  --use_png